...
export default function Footer () {
    ...
    return (
     <footer className="footer footer-center p-14 bg-base-100 text-base-content rounded">
      <nav>
        <div className="grid grid-flow-col gap-4">
          <a aria-label="GitHub" href="https://github.com/bpoole53"><svg height="32" viewBox="0 0 16 16" version="1.1" width="32" aria-hidden="true">
      ...
      <aside>
        <p>Copyright © 2023 - Ben Poole Studios</p>
      </aside>
     </footer>
    )
  }